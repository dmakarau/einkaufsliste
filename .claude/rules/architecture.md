...
- `category_keywords.dart` — keyword → category name map for offline prediction
- `openfoodfacts_category_map.dart` — OF taxonomy tag → category name map (specificity-ordered)
