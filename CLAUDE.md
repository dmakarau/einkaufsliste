...
Tests live in `test/blocs/` (Cubit unit tests), `test/services/` (service unit tests), and `test/helpers/` (shared fakes).
Covered: `ShoppingListCubit`, `ShoppingItemCubit`, `AuthCubit`, `SettingsCubit`, `ProductSearchService`.
