  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocListener<ShoppingListCubit, ShoppingListState>(
        // When a group sync completes it emits ShoppingListLoaded — use that
        // as a signal to reload items from Hive (pullAll already ran by then).
        listenWhen: (_, current) => current is ShoppingListLoaded,
        listener: (context, _) =>
            context.read<ShoppingItemCubit>().loadItems(widget.listId),
